...
import { Code2, PenTool, Search, Zap, Smartphone as Layers, ArrowRight } from 'lucide-react';

export const metadata: Metadata = {
  title: 'Services - Samuel Ikhifa | Web Development & SEO',
  description: 'Explore comprehensive web development and SEO services offered by Samuel Ikhifa. From responsive websites to search optimization, we deliver functional and impactful digital experiences.',
  keywords: 'Web Development, SEO Specialist, Frontend Development, Digital Services, Samuel Ikhifa',
  openGraph: {
    title: 'Services - Samuel Ikhifa | Web Development & SEO',
    description: 'Explore comprehensive web development and SEO services offered by Samuel Ikhifa. From responsive websites to search optimization, we deliver functional and impactful digital experiences.',
...
const services = [
  ...
  },
  {
    icon: PenTool,
    title: "UI/UX Design",
    description: "Create intuitive, beautiful user interfaces that delight users and drive engagement.",
  ...
  // },
  {
    ...
    description: "Improve visibility, ranking, and performance with data-driven SEO strategies.",
    features: [
      ...
      <section className="bg-lime-500 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 py-16">
          ...
          >
            ...
            Helping brands and products thrive through design and development that’s simple, modern, and impactful.
            </p>
          </div>
        </div>
      </section>
