        ...
        <div className="container mx-auto px-6 py-16">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center md:text-left order-1 md:order-2">
              ...
              Digital Experience Engineer obsessed with design clarity, frontend performance, and SEO that drives results. I build web experiences that are fast, intuitive, and built to grow.
              </p>
              
              {/* CTA Button */}
              <a href="/contact" className="bg-purple-600 text-white px-8 py-3 rounded-lg text-lg font-semibold hover:bg-purple-700 transition-colors inline-block">
                Let's Talk
              </a>
            </div>
          </div>
      ...
      <section className="bg-white py-12">
        <div className="container mx-auto px-6 flex flex-col md:flex-row gap-8 justify-center">
          ...
          <div className="flex-1 bg-white rounded-2xl shadow-lg p-6 md:p-8 text-center md:text-left">
            <h2 className="text-3xl md:text-4xl font-bold text-purple-900 mb-4">Frontend</h2>
            <p className="text-gray-700 text-base md:text-lg">
            Building fast, responsive, and scalable websites that deliver smooth user experiences across all devices.
            </p>
          </div>
          {/* UX Card */}
          <div className="flex-1 bg-white rounded-2xl shadow-lg p-6 md:p-8 text-center md:text-left">
            <h2 className="text-3xl md:text-4xl font-bold text-purple-900 mb-4">SEO</h2>
            <p className="text-gray-700 text-base md:text-lg">
            Optimizing websites for visibility, ranking, and growth — turning clicks into loyal users.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-12">
            <div>
              ...
              I help businesses and individuals build a strong online presence through design, development, and SEO strategies.
              </p>
            </div>
            <div className="mt-6 md:mt-0 text-center md:text-left">
              <a href="/services" className="bg-lime-500 text-white px-6 py-3 rounded-lg font-semibold hover:bg-lime-600 transition-colors inline-flex items-center space-x-2">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 flex flex-col items-center text-center">
              ...
              <h3 className="text-xl font-bold text-purple-900 mb-2">UI/UX Design</h3>
              <p className="text-gray-700">Creative and user-centered interfaces for web & mobile applications.</p>
            </div>
            {/* Service 2 */}
            <div className="bg-white rounded-2xl shadow-lg p-8 flex flex-col items-center text-center">
              <div className="w-16 h-16 bg-lime-200 rounded-full flex items-center justify-center mb-4">
              ...
              <h3 className="text-xl font-bold text-purple-900 mb-2">Web Development</h3>
              <p className="text-gray-700">Responsive, fast, and interactive websites built with modern technologies.</p>
            </div>
            {/* Service 3 */}
            <div className="bg-white rounded-2xl shadow-lg p-8 flex flex-col items-center text-center">
              <div className="w-16 h-16 bg-lime-200 rounded-full flex items-center justify-center mb-4">
              ...
              <h3 className="text-xl font-bold text-purple-900 mb-2">SEO Optimization</h3>
              <p className="text-gray-700">Improving visibility on search engines with data-driven strategies.</p>
            </div>
          </div>
        </div>
      </section>
    ...
    <div className="mb-12 flex flex-col md:flex-row md:items-center md:justify-between">
      <div>
        ...
        <p className="text-gray-600 text-lg">
          Showcasing my recent work and creative solutions for various clients and industries.
        </p>
      </div>
      <div className="mt-6 md:mt-0">
        <a href="/portfolio" className="bg-purple-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-purple-700 transition-colors inline-flex items-center space-x-2">
            ...
            <div className="p-6">
              <div className="mb-3">
                <div className="flex items-center justify-between">
                  ...
                  {(project.liveUrl && project.liveUrl.length > 0) || (project.githubUrl && project.githubUrl.length > 0) ? (
                    <a
                      href={
              ...
              <div className="relative w-full h-48 rounded-lg overflow-hidden mb-4">
                ...
                {project.imageUrl ? (
                  ...
                  <div className={`w-full h-full bg-gradient-to-br ${getGradientColors(project.category)} flex items-center justify-center`}>
                    <div className="text-center">
                      <div className={`w-16 h-16 ${getIconColor(project.category)} rounded-lg mx-auto mb-2`}></div>
                      <div className={`${getTextColor(project.category)} font-medium`}>
                        {project.category === 'UI/UX Design' ? 'Design Mockup' : 
                         project.category === 'Web Development' ? 'Web Platform' :                                                                                                          
                         project.category === 'App Design' ? 'App Mockup' : 'Project Mockup'}
                      </div>
                    </div>
                  </div>
                )}
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start mb-12">
            ...
            <div>
              <p className="text-white/80 text-lg">
                I've had the privilege of working with amazing companies and helping them achieve their design goals through innovative solutions and creative thinking.
              </p>
            </div>
          </div>
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg">
              ...
              <p className="text-gray-800 mb-4">
                "Samuel is a creative perfectionist. He's like a frog in getting better and project my team inspire about it. Sure to be next our best friend."
              </p>
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg">
              ...
              <p className="text-gray-800 mb-4">
                "Great your service. Thank you for helping us develop a product and work as an independent. Thank for the good service. Thanks again."
              </p>
              <div className="text-sm">
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 text-lg max-w-2xl mx-auto">
              Ready to bring your ideas to life with innovative design solutions. Let's create something amazing together.
            </p>
          </div>
